    ...
    <div id="center-column">
        <div class="top-bar">
            <a href="<?php echo base_url(); ?>pedidos/mantenimiento_pedidos" class="button">Cancelar</a>
            <a href="<?php echo base_url(); ?>pedidos/eliminarPedido/<?php echo $idpedidoActual ?>" class="button">Eliminar</a>
            <h1>Pedidos</h1>
            <div><a href="">Clientes</a> / <a href="">Eliminar Pedidos</a></div>
        </div>
