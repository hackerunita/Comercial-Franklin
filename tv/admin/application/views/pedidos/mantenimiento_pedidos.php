...
$nombre_pedido_buscar = array(
    'name' => 'nombre_pedido_buscar',
    'id' => 'nombre_pedido_buscar',
    'value' => set_value('nombre_pedido_buscar')
);
?>
...
<!--            <a href="<?php echo base_url(); ?>pedidos/crear_pedido" class="button">Crear Nuevo</a>-->
            <h1>Pedidos</h1>
            <div><a href="">Clientes</a> / <a href="">Pedidos</a></div>
        </div>
        <div class="container_12">
            <div class="grid_8">
                ...
                echo form_open('pedidos/buscar_pedido', $atributos);
                ?>
                ...
                if (isset($obtenerPedidos)) {
                    ...
                    foreach ($obtenerPedidos as $filaObtenerPedido):
                        ...
                        echo '<td width="70px">' . anchor('pedidos/actualizar_pedidos/' . $filaObtenerPedido->idpedidos, img($imagen_editar)) . '</td>';
                        echo '<td width="70px">' . anchor('pedidos/eliminar_pedidos/' . $filaObtenerPedido->idpedidos, img($imagen_eliminar)) . '</td>';
                        echo '</tr>';
                    endforeach;
                    echo '</table>';
                ...
                if (isset($obtenerPedidosPorNombre)) {
                    ...
                    if (!empty($obtenerPedidosPorNombre)) {
                        ...
                        foreach ($obtenerPedidosPorNombre as $filaObtenerPedidoPorNombre):
                            ...
                            echo '<td width="70px">' . anchor('pedidos/actualizar_pedidos/' . $filaObtenerPedidoPorNombre->idpedidos, img($imagen_editar)) . '</td>';
                            echo '<td width="70px">' . anchor('pedidos/eliminar_pedidos/' . $filaObtenerPedidoPorNombre->idpedidos, img($imagen_eliminar)) . '</td>';
                            echo '</tr>';
                        endforeach;
                        echo '</table>';
                        echo '<div class="select">';
