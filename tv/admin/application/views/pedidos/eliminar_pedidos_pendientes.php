    ...
    <div id="center-column">
        <div class="top-bar">
            ...
            <a href="<?php echo base_url(); ?>pedidos/eliminarPedidoPendiente/<?php echo $idpedidoActual ?>" class="button">Eliminar</a>
            <h1>Pedidos Pendientes</h1>
            <div><a href="">Clientes</a> / <a href="">Eliminar Pedidos Pendientes</a></div>
        </div>
