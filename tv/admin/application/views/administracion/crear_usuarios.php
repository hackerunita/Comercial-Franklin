...
<!-- fin de columna izquierda -->
    ...
    <div id="center-column">
        <div class="top-bar">
            ...
            <div><a href="">Administración</a> / <a href="">Crear Usuarios</a></div>
        </div>
        <div class="container_12">
            <div class="grid_8">
                <div class="grid_8 alpha" id="comentario_formulario" >
                    Complete el siguiente formulario para crear un nuevo usuario administrador.
                </div>
                ...
                <?php
                $atributos = array('id' => 'formulario_crear_usuario');
                echo form_open('administracion/crearUsuario', $atributos);
                ?>
                ...
                <div class="grid_2" id="imagen_boton">
                    <input class="boton_crear" type="submit" name="crear_usuario" value="">
                </div>
                <?php echo form_close(); ?>
