...
<div id="center-column">
    <div class="top-bar">
        ...
        <a href="<?php echo base_url(); ?>promociones/eliminarPromocion/<?php echo $idProductoActual; ?>" class="button">Eliminar</a>
        <h1>Promociones</h1>
        <div><a href="">Descuentos</a> / <a href="">Eliminar Promociones</a></div>
    </div>
